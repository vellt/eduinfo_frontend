...
class RowNavbarInstitution extends StatelessWidget {
            ...
            child: Row(
              ...
              children: [
                ...
                CupertinoButton(onPressed: () {
                  ...
                  child: SvgPicture.asset(
                    'assets/images/message${controller.index==1?(haveNotification)?3:4:(haveNotification)?2:1}.svg', // Az elérési útvonal
                    width: 40,
                    height: 40,
                  ),),
